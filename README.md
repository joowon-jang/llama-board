...
Llama Forge is a Windows-first desktop app for running `llama.cpp`, monitoring its local endpoint, and chatting with the model without leaving the app.
...
```powershell
irm https://raw.githubusercontent.com/<owner>/llama-command-builder/main/scripts/install.ps1 | iex
```
