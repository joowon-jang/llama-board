  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        <div className="brand"><div className="brand-mark">λ</div><div><strong>Llama Forge</strong><span>runtime · endpoint · chat</span></div></div>
        ...
        <div className="version">Llama Forge 0.1.0 · Windows first</div>
      </aside>
